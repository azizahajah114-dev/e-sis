...
<body class="bg-[#EFF5FE]  min-h-screen">
    <header>
        <div class="bg-[#5F9EF2]  p-2 flex items-center text-white top-6 left-0 right-0 z-40 gap-4">
            <img src="{{asset('storage/asset/logo.png')}}" alt="" class="w-8 h-10 mb-4 mt-2 md:w-12 md:h-12">
            <h1 class="text-white md:text-2xl font-extrabold text-md">e-SIS</h1>
        </div>
    </header>

    {{-- section 1  --}}
    <div class="container mx-auto p-4 mt-8 " data-aos="zoom-in-up ">
        <div class="bg-[#568EDA] rounded-2xl p-8 shadow-lg ">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0 md:space-x-8">
                ...
                <div class="flex flex-col text-white text-center md:text-left flex-1">
                    <h1 class="text-2xl md:text-4xl font-bold mb-2">Selamat Datang Di e-SIS</h1>
                    <p class="text-md text-start md:text-xl font-semibold mb-4 ">
                        Elektronik Surat Izin Sekolah - Cepat, Mudah, Digital
                        <br>
                        Mengajukan izin kini lebih praktis & transparan
                    </p>
                    <a href="{{ route('login') }}" class="mt-12 px-6 py-3 bg-blue-500 rounded-full text-white font-bold hover:bg-blue-600 transition duration-200 shadow-md md:self-start">
                        Mulai Gunakan
                    </a>
                </div>
                ...
                <div class="flex-shrink-0 right-0 left-0">
                    <img src="{{ asset('storage/asset/forms-animate.svg') }}" alt="Ilustrasi Selamat Datang" class="w-full max-w-xs md:max-w-md">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-[#568EDA] rounded-2xl p-8 shadow-lg">
            <div class="flex flex-col md:flex-row items-center md:justify-between space-y-8 md:space-y-0 md:space-x-8">
                <div class=" hidden md:block">
                    <img src="{{ asset('storage/asset/undraw_pair-programming_9jyg.svg') }}" alt="Ilustrasi Tentang Kami" class="w-full max-w-xs md:max-w-md">
                </div>
                ...
                <div class="flex flex-col text-white text-left md:text-left">
                    ...
                    <p class="text-lg md:text-lg font-semibold">
                    ...
                    <p class="text-lg md:text-lg font-semibold mt-4">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-lg p-6 flex flex-col items-center justify-between">
                            <div class="items-center text-center">
                                ...
                                <h1 class="text-2xl md:text-3xl font-bold mb-4">Mudah Digunakan</h1>
        ...
        <div class="bg-[#568EDA] rounded-2xl p-8 shadow-lg">
            ...
            <div class="flex flex-wrap -mx-2">
                ...
                <div class="bg-[#5F9EF2] rounded-lg p-6 flex items-center justify-between text-white"> 
                    ...
                    <div class="flex-shrink-0 hidden md:block"> {{-- Gambar di kanan --}}
